...
public class InquiryVO {
	...
	private String inqTypeCode;		// 문의유형코드
	private String inqStatCode;		// 처리상태코드
	...
	private InquiryCodeVO typeDetailCode;
	private InquiryCodeVO statDetailCode;
	
	private String inqTypeCodeDes;
	private String inqStatCodeDes;
