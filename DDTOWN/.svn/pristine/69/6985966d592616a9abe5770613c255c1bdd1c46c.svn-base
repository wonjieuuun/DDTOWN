...
<body>
	<div class="card login-card-custom">
        <div class="card-body">
            ...
            <div class="divider-text-custom">또는 다음으로 로그인</div>
            
            <div class="social-login-custom d-grid mb-4">
				<div>
	                <a href="${pageContext.request.contextPath}/oauth2/authorization/google" class="btn social-btn-google-custom me-3"> 
